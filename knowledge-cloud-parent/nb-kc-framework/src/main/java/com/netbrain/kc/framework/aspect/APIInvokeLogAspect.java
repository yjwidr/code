package com.netbrain.kc.framework.aspect;
...
public class APIInvokeLogAspect {
    ...
    private static Logger logger = LogManager.getLogger(APIInvokeLogAspect.class.getName());

    @Pointcut("execution(public * com.netbrain.kc.api.consumer.*.*(..))")
