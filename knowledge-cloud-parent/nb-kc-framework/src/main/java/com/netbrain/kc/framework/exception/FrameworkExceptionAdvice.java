...
public class FrameworkExceptionAdvice {
    private static Logger logger = LogManager.getLogger(FrameworkExceptionAdvice.class.getName());
    ...
    public ResponseEntity handleFrameworkException(FrameworkException e) {
        logger.error(e.getMessage(),e);
