...
public class ContentController {
    ...
    @PreAuthorize("hasPermission(#target, '"+Constants.UPLOAD+"')")
    ...
    @PreAuthorize("hasPermission(#target, '"+Constants.PUBLISH+"')")
    ...
    @PreAuthorize("hasPermission(#target, '"+Constants.DISABLE+"')")
    ...
    @PreAuthorize("hasPermission(#target, '"+Constants.DOWNLOAD+"')")
