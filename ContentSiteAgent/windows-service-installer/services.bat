...
set EXECUTABLE=%CD%\NetBrainUpdateService.exe
set SERVICE_ID=NetBrainUpdateService
goto checkExe
...
echo NetBrainUpdateService.exe was not found...
...
sc config "%SERVICE_ID%" displayname="NetBrain Update Service"
goto:eof
...
if "%ip%"=="Started"  (
	echo The service with id 'NetBrainUpdateService' is running, please stop it first.
	goto:eof
)
