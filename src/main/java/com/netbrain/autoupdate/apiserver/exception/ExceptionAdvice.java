...
public class ExceptionAdvice {
    ...
    public ResponseEntity handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        ...
        return new ResponseEntity(HttpStatus.NOT_FOUND.value(),e.getMessage());
    }
...
//        logger.error(e.getMessage(),e);
//        return new ResponseEntity(HttpStatus.BAD_REQUEST.value(),e.getMessage());
//    }
    ...
    public ResponseEntity handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        logger.error(e.getMessage(),e);
        return new ResponseEntity(HttpStatus.METHOD_NOT_ALLOWED.value(),e.getMessage());
    }
    ...
    public ResponseEntity handleHttpMediaTypeNotSupportedException(HttpMediaTypeNotSupportedException e) {
        logger.error(e.getMessage(),e);
        return new ResponseEntity(HttpStatus.UNSUPPORTED_MEDIA_TYPE.value(),e.getMessage());
    }    
